    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'logged in' ? 'http://127.0.0.1:3000/api/v1/users/login' : 'http://127.0.0.1:3000/api/v1/users/signup';
            _context.next = 4;
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "\u2714 ".concat(type.toUpperCase(), " successfully"));
...
var stripe = Stripe('pk_test_51Ie2scAtZ3npWhXt33Xt6x9ZgVhChJBBdA1z3feqrENeyMIqTKl8cA05oJ9N4rCUezKu0VsRfPbQWrwE2lcdmS6I00Wds749xz');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            (0, _alert.showAlert)('error', "\u2718 ".concat(_context.t0));
...
if (signupForm) {
  signupForm.addEventListener('submit', function (event) {
    ...
    var passwordConfirm = document.getElementById('s_confirmPassword').value;
    (0, _auth.auth)({
      name: name,
      email: email,
      password: password,
